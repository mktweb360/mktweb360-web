  ...
  return (
    <form onSubmit={handleSubmit}>
      ...
      <div className="space-y-4">
        ...
        {status === "error" && <div className="bg-red-50 border border-red-200 rounded-xl px-4 py-3 text-sm text-red-700">Error al enviar. LlÃ¡manos al <a href="tel:+34622748987" className="font-semibold underline">622 74 89 87</a>.</div>}
