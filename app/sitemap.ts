...
export default function sitemap(): MetadataRoute.Sitemap {
  const pages = [
    ...
    { url: "/5-factores-web-restaurantes-hosteleria/", priority: 0.8, changeFrequency: "monthly" as const },
    { url: "/5-factores-web-construccion-reformas/", priority: 0.8, changeFrequency: "monthly" as const },
    { url: "/5-factores-web-academias-centros-formacion/", priority: 0.8, changeFrequency: "monthly" as const },
    { url: "/5-factores-web-clinicas-dentales/", priority: 0.8, changeFrequency: "monthly" as const },
    { url: "/5-factores-web-talleres-mecanicos/", priority: 0.8, changeFrequency: "monthly" as const },
    { url: "/5-factores-web-peluquerias-estetica/", priority: 0.8, changeFrequency: "monthly" as const },
    { url: "/5-factores-web-servicios-profesionales/", priority: 0.8, changeFrequency: "monthly" as const },
    { url: "/5-factores-web-asesorias-gestorias/", priority: 0.8, changeFrequency: "monthly" as const },
