...
export async function generateMetadata({ params }: { params: Promise<{ lang: string }> }) {
  ...
  return {
    title: isEn
      ? "Web Analytics Service for Businesses — GA4 and GTM | Mkt Web 360"
      : "Service d'Analytique Web pour Entreprises — GA4 et GTM | Mkt Web 360",
    description: isEn
          ...
          <div>
            <Breadcrumbs
              crumbs={[
                ...
                { label: isEn ? "Web Analytics" : "Analytique Web" },
              ]}
            />
            <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight mt-4">
              {isEn ? "Web analytics" : "Analytique web"}<br />
              <span className="text-accent-400">
                {isEn ? "data that drives decisions" : "des données qui guident les décisions"}
              </span>
            </h1>
