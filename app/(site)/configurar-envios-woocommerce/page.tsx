  ...
  return (
    <>
      ...
      <div className="max-w-3xl mx-auto px-4 py-12">
        ...
        <p className="text-gray-700 leading-relaxed mb-4">El coste de envío es una de las principales causas de <Link href="/seo-para-ecommerce-errores-que-frenan-ventas/" className="text-accent-500 hover:underline">abandono del carrito en ecommerce</Link>. Según estudios de Baymard Institute, el 48% de los carritos abandonados lo son por costes adicionales demasiado altos (envío, impuestos, tasas). La estrategia de precios de envío tiene impacto directo en la tasa de conversión.</p>
