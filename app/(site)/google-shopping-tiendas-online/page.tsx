  ...
  return (
    <>
      ...
      <div className="max-w-3xl mx-auto px-4 py-12">
        ...
        <p className="text-gray-700 leading-relaxed mb-4">Hay dos formas de aparecer en Google Shopping: los resultados orgánicos gratuitos (fichas de producto gratuitas en Google Search y Google Shopping) y los anuncios de Shopping de pago (Performance Max o Shopping estándar en Google Ads). Para los resultados orgánicos gratuitos, basta con tener el feed de productos correctamente configurado en Google Merchant Center. Para los anuncios de pago, además necesitas vincular Merchant Center con Google Ads y configurar una campaña.</p>
        ...
        <p className="text-gray-700 leading-relaxed mb-4">Analiza el rendimiento por categoría de producto: habitualmente el 20% de los productos genera el 80% de las ventas en Google Shopping. Concentra la inversión en los productos con mejor ROAS e identifica los productos con alto CTR pero baja conversión (lo que indica un problema en la página de producto o en el precio) para optimizarlos.</p>
