...
export default function GraciasTiendaOnlinePage() {
  return (
    <section className="min-h-[80vh] flex items-center justify-center px-4 py-16 bg-gray-50">
      <div className="max-w-lg w-full text-center">
        ...
        <p className="text-gray-500 text-lg mb-8 leading-relaxed">
          Hemos recibido tu solicitud para la tienda online desde 490&#8364;.<br />
        ...
        <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-6 text-left mb-8">
          <p className="text-xs font-bold text-gray-400 uppercase tracking-widest mb-4">Que pasa ahora</p>
          <ol className="space-y-4">
            {[
              { n: "1", t: "Revisamos tu proyecto", d: "Analizamos tu sector, catalogo y necesidades antes de llamarte." },
              { n: "2", t: "Te llamamos en menos de 24h", d: "Confirmamos disponibilidad y resolvemos tus dudas." },
              { n: "3", t: "Tu tienda en marcha", d: "Si encaja, arrancamos el diseno. Tienda lista en 2-3 semanas." },
            ].map(paso => (
        ...
        <div className="flex flex-col sm:flex-row gap-3 justify-center">
          ...
          <a href="https://wa.me/34696714760?text=Hola%2C%20acabo%20de%20solicitar%20informacion%20sobre%20la%20tienda%20online" target="_blank" rel="noopener noreferrer" className="flex items-center justify-center gap-2 bg-green-500 hover:bg-green-600 text-white font-bold px-6 py-3 rounded-full text-sm transition-colors">&#128172; WhatsApp</a>
        </div>
        <div className="mt-8">
