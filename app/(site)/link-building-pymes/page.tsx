...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [{ url: "https://www.mktweb360.com/og-link-building-pymes.jpg", width: 1200, height: 630 }],
  },
};
...
const articleSchema = {
  ...
  image: "https://www.mktweb360.com/og-link-building-pymes.jpg",
  url: "https://www.mktweb360.com/link-building-pymes/",
  ...
  return (
    <>
      ...
      <div className="max-w-3xl mx-auto px-4 py-12">
        ...
        <p className="text-gray-700 leading-relaxed mb-4">Desde que Google comenzó a usar los enlaces como señal de autoridad en 1998, los backlinks han permanecido como uno de los factores de posicionamiento más relevantes. A pesar de todos los cambios algorítmicos de los últimos 25 años, el consenso entre los profesionales SEO es que los backlinks de calidad siguen siendo fundamentales para <Link href="/seo-posicionamiento-web-organico/" className="text-accent-500 hover:underline">posicionar en términos competitivos</Link>.</p>
        ...
        <p className="text-gray-700 leading-relaxed mb-4">Los directorios de mayor valor para negocios en España incluyen: <Link href="/google-business-profile/" className="text-accent-500 hover:underline">Google Business Profile</Link> (fundamental), Páginas Amarillas, Yelp España, Hotfrog, Europages (para negocios B2B), y los directorios de la asociación empresarial de tu sector. Para negocios locales, el directorio del ayuntamiento o cámara de comercio también puede ser una fuente de backlinks con autoridad local.</p>
        <p className="text-gray-700 leading-relaxed mb-4">La clave es la consistencia de NAP (Name, Address, Phone): el nombre, dirección y teléfono deben ser exactamente iguales en todos los directorios. Inconsistencias en el NAP confunden a Google sobre la ubicación de tu negocio y reducen la eficacia de estos backlinks para <Link href="/seo-local-empresas-servicios/" className="text-accent-500 hover:underline">el SEO local</Link>.</p>
