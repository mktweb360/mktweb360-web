...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [{ url: "https://www.mktweb360.com/og-como-crear-landing-page-que-convierte.jpg", width: 1200, height: 630 }],
  },
};
...
const articleSchema = {
  ...
  image: "https://www.mktweb360.com/og-como-crear-landing-page-que-convierte.jpg",
  url: "https://www.mktweb360.com/como-crear-landing-page-que-convierte/",
  ...
  return (
    <>
      ...
      <div className="max-w-3xl mx-auto px-4 py-12">
        ...
        <p className="text-gray-700 leading-relaxed mb-4">A diferencia de la <Link href="/diseno-de-paginas-web/" className="text-accent-500 hover:underline">página de inicio de una web</Link>, que ofrece múltiples opciones de navegación y presenta toda la empresa, una landing page elimina distracciones y dirige al usuario hacia una decisión única. Esta concentración de foco es exactamente lo que la hace más efectiva que cualquier otra página de una web corporativa estándar.</p>
        <p className="text-gray-700 leading-relaxed mb-4">Las landing pages son especialmente importantes en las <Link href="/sem-publicidad-ppc/" className="text-accent-500 hover:underline">campañas de publicidad de pago</Link> (Google Ads, Meta Ads) porque cuando alguien hace clic en tu anuncio, está en el pico de su intención. Si le envías a tu página de inicio en lugar de a una página diseñada específicamente para convertir esa intención, estás desperdiciando el coste de ese clic.</p>
        ...
        <p className="text-gray-700 leading-relaxed mb-4">Para optimizar una landing page necesitas datos. <Link href="/como-medir-roi-marketing-digital/" className="text-accent-500 hover:underline">Google Analytics 4</Link> con eventos configurados te dice cuántos usuarios llegan, cuántos completan el formulario y en qué punto de la página abandonan. Herramientas de mapas de calor como Hotjar o Microsoft Clarity muestran exactamente dónde hace clic la gente y hasta dónde scrollan, lo que revela dónde se pierde el interés.</p>
