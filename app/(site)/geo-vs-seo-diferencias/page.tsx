  ...
  return (
    <>
      ...
      <div className="max-w-3xl mx-auto px-4 py-12">
        ...
        <p className="text-xl text-gray-500 mb-8 leading-relaxed">El SEO optimiza tu presencia en Google. El GEO (Generative Engine Optimization) optimiza tu presencia en ChatGPT, Perplexity y Gemini. No son excluyentes — se complementan. Pero requieren enfoques diferentes que vale la pena entender.</p>
        ...
        <p className="text-gray-700 leading-relaxed mb-4">El GEO (Generative Engine Optimization) es la disciplina de optimizar la presencia de una marca, empresa o experto en los motores de respuesta generativa: ChatGPT, Perplexity, Claude, Gemini y los AI Overviews de Google. Cuando alguien le pregunta a ChatGPT "¿cuál es la mejor agencia de marketing digital en España?", el GEO determina si tu empresa aparece en la respuesta generada o no.</p>
