...
export const metadata: Metadata = {
  title: "Paquete SEO + GEO + GBP al 50% — Oferta Agosto 2026",
  description: "Vete de vacaciones tranquilo. Cuando vuelvas, tu empresa ya aparece en Google, en la IA y en el mapa. Paquete SEO + GEO + GBP al 50% solo en agosto 2026. 5 plazas.",
  alternates: { canonical: "https://www.mktweb360.com/oferta-seo-geo-gbp/" },
  robots: { index: true, follow: true },
  openGraph: {
    title: "Paquete SEO + GEO + GBP al 50% — Oferta Agosto 2026",
    description: "SEO + IA + Google Maps desde 349€/mes. Solo agosto, 5 plazas. Posiciónate ahora y llega al Q4 visible en Google, ChatGPT y el mapa.",
...
const faqSchema = {
  ...
  mainEntity: [
    ...
    },
    {
      ...
      acceptedAnswer: {
        "@type": "Answer",
        text: "Es una oferta limitada al mes de agosto 2026. El precio real de mercado del paquete completo es 699€/mes. Lo ofrecemos al 50% para incorporar nuevas cuentas antes de la temporada alta del Q4.",
      },
    },
    {
      "@type": "Question",
      name: "¿Por qué empezar en agosto y no en septiembre?",
      acceptedAnswer: {
        "@type": "Answer",
        text: "Septiembre es la vuelta al cole del mundo empresarial: presupuestos aprobados y decisiones tomadas. El SEO y el GEO tardan meses en dar resultados. Si empiezas en septiembre, estarás posicionado en marzo. Si empiezas en agosto, en octubre y noviembre —cuando más se decide— ya eres visible y llegas al Q4 posicionado.",
      },
    },
    {
      "@type": "Question",
    ...
    <>
      ...
      <section className="bg-gradient-to-br from-primary-700 to-primary-900 text-white relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-5xl mx-auto px-4 py-16 md:py-24">
          <Breadcrumbs crumbs={[{ label: "Inicio", href: "/" }, { label: "Oferta Agosto SEO + GEO + GBP" }]} />
          <div className="max-w-3xl mt-4">
            <div className="flex items-center gap-3 mb-6">
              <span className="inline-block bg-accent-500 text-white text-xs font-bold px-3 py-1 rounded-full uppercase tracking-widest">Oferta agosto 2026</span>
            ...
            <p className="text-xl text-primary-200 mb-6 leading-relaxed">
              Mientras descansas, nosotros posicionamos tu empresa en Google, en ChatGPT y en el mapa.
              Llega al Q4 visible. Paquete SEO + GEO + GBP al 50% del precio de mercado.
            </p>
      ...
      <section className="bg-primary-600 py-5 px-4">
        <div className="max-w-4xl mx-auto grid grid-cols-2 md:grid-cols-4 gap-4 text-center text-white">
          {[
            ...
            { value: "Solo 5", label: "plazas en agosto" },
          ].map((m) => (
            <div key={m.label}>
      ...
      <div className="bg-accent-500 py-3 px-4 text-center">
        <p className="text-white text-sm font-semibold">
          ☀️ Oferta solo agosto · <strong>349€/mes en lugar de 699€</strong> · <strong>Solo 5 plazas</strong>
        </p>
      </div>
      ...
      <section className="py-16 px-4">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-2xl font-bold text-primary-600 mb-6">El último cuatrimestre empieza en agosto</h2>
          <p className="text-gray-700 leading-relaxed mb-4">
            Octubre, noviembre y diciembre son los meses en los que las empresas toman decisiones de compra, cierran proveedores
            y definen el presupuesto del año siguiente. Para llegar visible al Q4, hay que empezar ahora.
          </p>
          <p className="text-gray-700 leading-relaxed">
            El SEO y el GEO no son publicidad de pago: tardan meses en dar resultados. Si empiezas en septiembre,
            estarás posicionado en marzo. <strong className="text-primary-700">Si empiezas en agosto, el Q4 ya te encuentra visible.</strong>
          </p>
        </div>
      </section>
      ...
      <section id="reservar" className="py-16 px-4 bg-primary-600 text-white">
        <div className="max-w-3xl mx-auto">
          <div className="text-center mb-10">
            ...
            <h2 className="text-3xl font-bold mb-4">Reserva tu plaza en agosto</h2>
            <p className="text-primary-200">Rellena el formulario en menos de 2 minutos. Te contactamos en menos de 24 horas para que el Q4 ya te encuentre posicionado.</p>
          </div>
