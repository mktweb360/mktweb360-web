  ...
  return (
    <>
      ...
      <div className="max-w-3xl mx-auto px-4 py-12">
        ...
        <p className="text-gray-700 leading-relaxed mb-4"><strong>Llms.txt:</strong> Este archivo es una representación orientativa y legible del sitio para sistemas de IA. No controla el acceso de crawlers ni garantiza indexación ni citación, y no es una señal oficial de Google. Su valor es facilitar que los modelos de lenguaje encuentren y estructuren tu contenido más relevante.</p>
