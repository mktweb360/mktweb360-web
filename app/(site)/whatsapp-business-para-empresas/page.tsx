  ...
  return (
    <>
      <div className="max-w-3xl mx-auto px-4 py-12">
        ...
        <p className="text-gray-700 leading-relaxed mb-4"><strong>Dirección y web:</strong> Añade tu dirección física si tienes local y el enlace a tu web. Estos datos aparecen en tu perfil y ayudan a los clientes a encontrarte.</p>
        ...
        <p className="text-gray-700 leading-relaxed mb-4">El método más directo es añadir el botón de WhatsApp en tu web y en tus perfiles de redes sociales. El enlace directo (wa.me/34TUTELEFONO) permite iniciar una conversación con un clic sin necesidad de guardar el número. Añade un mensaje preescrito en el enlace para reducir la fricción: "wa.me/34622748897?text=Hola, quiero más información sobre vuestros servicios".</p>
        <p className="text-gray-700 leading-relaxed mb-4">Para negocios que hacen publicidad en Meta (Facebook e Instagram), los anuncios con CTA de WhatsApp tienen generalmente una tasa de conversión superior a los anuncios con formulario porque reducen la fricción: el usuario hace clic y directamente empieza una conversación, sin rellenar datos.</p>
