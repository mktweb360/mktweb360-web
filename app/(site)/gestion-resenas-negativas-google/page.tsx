...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [{ url: "https://www.mktweb360.com/og-gestion-resenas-negativas-google.jpg", width: 1200, height: 630 }],
  },
};
...
const articleSchema = {
  ...
  image: "https://www.mktweb360.com/og-gestion-resenas-negativas-google.jpg",
  url: "https://www.mktweb360.com/gestion-resenas-negativas-google/",
  ...
  return (
    <>
      ...
      <div className="max-w-3xl mx-auto px-4 py-12">
        ...
        <p className="text-gray-700 leading-relaxed mb-4">Una reseña negativa no solo puede disuadir a un cliente potencial; puede aparecer en Google Maps e influir en decenas o cientos de personas que <Link href="/seo-local-empresas-servicios/" className="text-accent-500 hover:underline">buscan tu tipo de negocio</Link> cada mes. Por eso, la gestión proactiva de reseñas no es opcional: es parte de la <Link href="/reputacion-online/" className="text-accent-500 hover:underline">estrategia de marketing digital</Link> de cualquier negocio con presencia local.</p>
