...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [{ url: "https://www.mktweb360.com/og-como-medir-roi-marketing-digital.jpg", width: 1200, height: 630 }],
  },
};
...
const articleSchema = {
  ...
  image: "https://www.mktweb360.com/og-como-medir-roi-marketing-digital.jpg",
  url: "https://www.mktweb360.com/como-medir-roi-marketing-digital/",
  ...
  return (
    <>
      ...
      <div className="max-w-3xl mx-auto px-4 py-12">
        ...
        <p className="text-gray-700 leading-relaxed mb-4">Google Analytics 4 (GA4) es la herramienta gratuita más potente para <Link href="/analitica-web/" className="text-accent-500 hover:underline">medir el rendimiento de tu marketing digital</Link>. Pero sin configurar correctamente el seguimiento de conversiones, solo te da datos de tráfico — no de resultados de negocio.</p>
